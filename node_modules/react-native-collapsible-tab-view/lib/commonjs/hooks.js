...
function useLayoutHeight(initialHeight = 0) {
...
function useCollapsibleStyle() {
  ...
  const containerHeightWithMinHeader = Math.max(0, (containerHeight ?? 0) - minHeaderHeight);
  return (0, _react.useMemo)(() => ({
    ...
    _helpers.IS_IOS && allowHeaderOverscroll ? 0 :
    ...
    if (typeof snapThreshold === 'number') {
      if (revealHeaderOnScroll) {
          ...
          if (scrollYCurrent.value > headerScrollDistance.value * snapThreshold) {
            if (accDiffClamp.value <= headerScrollDistance.value * snapThreshold) {
              ...
              if (scrollYCurrent.value < headerScrollDistance.value) {
                ...
                scrollAnimation.value = (0, _reactNativeReanimated.withTiming)(headerScrollDistance.value);
        ...
        if (scrollYCurrent.value <= headerScrollDistance.value * snapThreshold) {
          ...
          snappingTo.value = 0;
          scrollAnimation.value = scrollYCurrent.value;
          scrollAnimation.value = (0, _reactNativeReanimated.withTiming)(0);
