 ...
 */const FlatListMemo = /*#__PURE__*/_react.default.memo(/*#__PURE__*/_react.default.forwardRef((props, passRef) => {
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_helpers.AnimatedFlatList, {
    ref: passRef,
    ...props
  });
}));
function FlatListImpl({
  ...
  return (
    ...
    (0, _jsxRuntime.jsx)(FlatListMemo, {
      ...rest,
      onLayout: onLayout,
      ref: ref,
      bouncesZoom: false,
 ...
 */
const FlatList = exports.FlatList = /*#__PURE__*/_react.default.forwardRef(FlatListImpl);
